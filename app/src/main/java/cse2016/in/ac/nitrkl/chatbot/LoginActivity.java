...
public class LoginActivity extends AppCompatActivity {
    ...
    //table 1 data
    public static String[] areas ={"BBA","Library","Architecture","NCC","Basket ball","Train","Water Tank","area8","area9","area10"};
...
//    table 2 data
    public static String[] areas2 ={"BBA","Library","Architecture","NCC","Basket ball","Train","Water Tank","area8","area9","area10"};
